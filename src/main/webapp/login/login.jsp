                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <span style="color: red" id="loginMessage">1231</span>
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 285px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       type="test" name="Codee" id="form-code" required>
                            </div>
